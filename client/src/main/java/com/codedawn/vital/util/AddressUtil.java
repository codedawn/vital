 ...
 *
 *           parseLocalAddress:127.0.0.1:8000
 *           parseLocalIP:127.0.0.1
 *           parseRemoteAddress:127.0.0.1:14153
 *           parseRemoteHostName:www.xmind.net
 *           parseRemoteIP:127.0.0.1
 *           parseSocketAddressToHostIp:127.0.0.1
 *           parseRemotePort:14153
 *
 *           System.out.println("parseLocalAddress:"+ AddressUtil.parseLocalAddress(ctx.channel()));
 *           System.out.println("parseLocalIP:"+AddressUtil.parseLocalIP(ctx.channel()));
 *           System.out.println("parseRemoteAddress:"+AddressUtil.parseRemoteAddress(ctx.channel()));
 *           System.out.println("parseRemoteHostName:"+AddressUtil.parseRemoteHostName(ctx.channel()));
 *           System.out.println("parseRemoteIP:"+AddressUtil.parseRemoteIP(ctx.channel()));
 *           System.out.println("parseSocketAddressToHostIp:"+AddressUtil.parseSocketAddressToHostIp(ctx.channel().remoteAddress()));
 *           System.out.println("parseRemotePort:"+AddressUtil.parseRemotePort(ctx.channel()));
 */
