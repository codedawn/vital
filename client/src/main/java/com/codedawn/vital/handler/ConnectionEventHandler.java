...
import com.codedawn.vital.callback.ChannelStatusCallBack;
...
public class ConnectionEventHandler extends ChannelInboundHandlerAdapter {
    ...
    public ConnectionEventHandler setConnectionEventListener(ConnectionEventListener connectionEventListener) {
    ...
    public ConnectionEventHandler(ConnectionEventListener connectionEventListener, ChannelStatusCallBack channelStatusCallBack) {
        this.connectionEventListener = connectionEventListener;
        this.channelStatusCallBack = channelStatusCallBack;
    }

    public ConnectionEventHandler setChannelStatusCallBack(ChannelStatusCallBack channelStatusCallBack) {
        this.channelStatusCallBack = channelStatusCallBack;
        return this;
    }
