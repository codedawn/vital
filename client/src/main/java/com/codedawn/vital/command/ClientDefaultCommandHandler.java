...
public class ClientDefaultCommandHandler implements CommandHandler<DefaultMessageContext> {
    ...
    public ClientDefaultCommandHandler(ProcessorManager processorManager, ReceiveQos receiveQos, SendQos sendQos, Sender sender, MessageCallBack messageCallBack) {
    ...
    public ClientDefaultCommandHandler setProcessorManager(ProcessorManager processorManager) {
        this.processorManager = processorManager;
        return this;
    }
    ...
    public ClientDefaultCommandHandler setReceiveQos(ReceiveQos receiveQos) {
        this.receiveQos = receiveQos;
        return this;
    }
    ...
    public ClientDefaultCommandHandler setSendQos(SendQos sendQos) {
        this.sendQos = sendQos;
        return this;
    }
