package com.codedawn.vital.client.proto;
...
/**
 * @author codedawn
 * @date 2021-07-26 22:04
 */
public class VitalClientProtocol implements Protocol {
    ...
    public VitalClientProtocol(CommandHandler commandHandler) {
